	...
	public class Button extends LabelButton implements IFocusManagerComponent {
		...
		override public function drawFocus(focused:Boolean):void {
			...
			if (focused) {
				...
				var fPadding:Number = (focusPadding == null) ? 2 : Number(focusPadding);
				fPadding += emphasizedPadding;
				
				uiFocusRect.x = -fPadding;
				uiFocusRect.y = -fPadding;
				uiFocusRect.width = width + (fPadding*2);
				uiFocusRect.height = height + (fPadding*2);
			}
		}
