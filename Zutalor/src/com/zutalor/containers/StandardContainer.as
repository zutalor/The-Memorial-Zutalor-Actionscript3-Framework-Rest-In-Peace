package com.zutalor.containers
{
	 ...
	 * @author Geoff Pepos
	 */
	public class StandardContainer extends MotionSprite implements IDisposable
	{
		...
		public function StandardContainer(containerName:String, width:Number=0, height:Number=0) 
		{
