...
package com.zutalor.utils 
{
	...
	public class FPSMeter extends Sprite {
		...
		public function FPSMeter(textColor:uint=0x000000, drawShadow:Boolean=false, showGraph:Boolean=true, graphColor:uint=0xff0000) {
		...
		private function onTimer(event:TimerEvent):void {
			frameRate =computeTime();
			_text.text=Math.floor(frameRate).toString()+" fps";
			_text.setTextFormat(_tf);
			_text.autoSize="left";
			if (_showGraph) {
				updateGraph(frameRate);
			}
		}
